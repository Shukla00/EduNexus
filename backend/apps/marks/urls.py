...
from .views import (
    ...
    ExamScheduleListCreateView,StudentMarksPerformanceView,ExamScheduleDetailView,
)
...
urlpatterns = [
    ...
    path('exam-schedules/', ExamScheduleListCreateView.as_view(), name='exam-schedules'),
    path(
        'exam-schedules/',
        ExamScheduleListCreateView.as_view()
    ),
    path(
        'exam-schedules/<int:pk>/',
