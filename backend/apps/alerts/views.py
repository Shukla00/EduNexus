...
class AlertSerializer(serializers.ModelSerializer):
    ...
    # 🔥 ADD ML FIELDS HERE
    ml_prediction = serializers.CharField(read_only=True)
    ml_confidence = serializers.FloatField(read_only=True)
    ml_avg_score = serializers.FloatField(read_only=True)
