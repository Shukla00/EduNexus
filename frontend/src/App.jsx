...
import ManageOfflineExams from './pages/admin/ManageOfflineExams'
...
// Shared
import ExamSchedule from './pages/shared/ExamSchedule'
      ...
      <AuthProvider>
        ...
        <Routes>
          ...
          <Route path="/admin" element={<PrivateRoute roles={['ADMIN']}><DashboardLayout /></PrivateRoute>}>
            ...
            <Route path="exams" element={<ManageOfflineExams />} />
