...
export const studentsApi = {
  ...
  studentPerformance: (id) => api.get(`/students/${id}/performance/`),
}
...
export const marksApi = {
  ...
  studentPerformance: (id) => api.get(`/marks/student-performance/${id}/`),
}

// ===== Offline Exam Schedules =====
export const examSchedulesApi = {
  list: (params) => api.get('/marks/exam-schedules/', { params }),
  create: (data) => api.post('/marks/exam-schedules/', data),
  update: (id, data) => api.patch(`/marks/exam-schedules/${id}/`, data),
  delete: (id) => api.delete(`/marks/exam-schedules/${id}/`),
}
...
export const aiApi = {
  ...
  studentSummary: () => api.get('/ai/student-summary/'),
  uploadDocument: (formData) => api.post('/ai/documents/upload/', formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
  deleteDocument: (id) => api.delete(`/ai/documents/${id}/`),
  chat: (prompt) => api.post('/ai/chat/', { prompt }),
  whoami: () => api.get('/ai/whoami/'),
}
