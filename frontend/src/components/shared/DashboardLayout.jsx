...
import {
  ...
  Building2, Brain, TrendingUp, CreditCard, UserCircle, BookMarked, CalendarCheck, MessageSquareText
} from 'lucide-react'
...
const NAV_CONFIG = {
  ADMIN: [
    ...
    { icon: CalendarCheck, label: 'Offline Exams', to: '/admin/exams' },
    { icon: Brain, label: 'AI Alerts', to: '/admin/alerts', badge: true },
    { icon: MessageSquareText, label: 'AI Chatbot', to: '/admin/chatbot' },
  ...
  FACULTY: [
    ...
    { icon: BookOpen, label: 'My Subjects', to: '/faculty/courses' },
    ...
    { icon: CalendarCheck, label: 'Exam Schedule', to: '/faculty/exams' },
    { icon: Brain, label: 'AI Alerts', to: '/faculty/alerts', badge: true },
    { icon: MessageSquareText, label: 'AI Chatbot', to: '/faculty/chatbot' },
  ...
  STUDENT: [
    ...
    { icon: CalendarCheck, label: 'Upcoming Exams', to: '/student/exams' },
    { icon: Brain, label: 'AI Alerts', to: '/student/alerts', badge: true },
    { icon: MessageSquareText, label: 'AI Chatbot', to: '/student/chatbot' },
