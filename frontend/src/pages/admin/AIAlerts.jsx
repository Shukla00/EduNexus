                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2 flex-wrap mb-1">
                      ...
                      {alert.ml_prediction && (
                        <span className={alert.ml_prediction === 'Fail' ? 'badge-red' : 'badge-green'}>
                          ML: {alert.ml_prediction} {alert.ml_confidence ? `${alert.ml_confidence}%` : ''}
                        </span>
                      )}
            ...
            <div className="p-6 space-y-4">
              ...
              {selected.ml_prediction && (
                <div className="grid grid-cols-3 gap-3">
                  <div className="p-3 bg-surface-50 rounded-lg">
                    <p className="text-xs text-slate-500">ML Prediction</p>
                    <p className="font-semibold text-slate-900">{selected.ml_prediction}</p>
                  </div>
                  <div className="p-3 bg-surface-50 rounded-lg">
                    <p className="text-xs text-slate-500">Confidence</p>
                    <p className="font-semibold text-slate-900">{selected.ml_confidence ?? '-'}%</p>
                  </div>
                  <div className="p-3 bg-surface-50 rounded-lg">
                    <p className="text-xs text-slate-500">Avg Score</p>
                    <p className="font-semibold text-slate-900">{selected.ml_avg_score ?? '-'}</p>
                  </div>
                </div>
              )}
